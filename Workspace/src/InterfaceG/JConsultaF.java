...
public class JConsultaF extends JFrame {
	...
	public JConsultaF() {
		...
		JLabel lblOrientacao = new JLabel("Insira por gentileza o CPF do Funcionario que deseja buscar:");
		lblOrientacao.setFont(new Font("Bookman Old Style", Font.ITALIC, 13));
		...
		lblLogin.setBounds(173, 368, 45, 23);
