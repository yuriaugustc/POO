...
public class Consulta extends Agendamento implements Serializable{
    ...
    public Consulta(String nomeP, String data_nascimentoP, String sexoP, String CPFP, String RGP, String estado_civilP, String ruaP, int nroP, String complementoP, String bairroP, String cepP, String cidadeP, 
    				String nomeM, String CRMM,
    				String nomeF, int matriculaF,
    				String dataConsulta, String horaConsulta){
        this.setPaciente(nomeP, data_nascimentoP, sexoP, CPFP, RGP, estado_civilP, ruaP, nroP, complementoP, bairroP, cepP, cidadeP);
    ...
    public int RealizarConsulta(String cpf, String hora, String data, double valor, String medicamentos[], String receita){
