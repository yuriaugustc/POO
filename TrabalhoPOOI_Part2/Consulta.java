...
public class Consulta extends Agendamento{
    ...
    public Consulta(String nomePaciente, String cpfPaciente, String nomeMedico, String dataConsulta, String horaConsulta, String[] medicamentos, String receita, double valorConsulta) {
