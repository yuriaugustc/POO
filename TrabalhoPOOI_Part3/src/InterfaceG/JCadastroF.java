		...
		btnConcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (aux.equals("medico") || aux.equals("médico")) {
					...
					medico.setEndereco(TRua.getText(), nro, TComplemento.getText(), TBairro.getText(), TCEP.getText(),
							TCidade.getText());
				...
				int nro = Integer.parseInt(TNumero.getText());
				func.setEndereco(TRua.getText(), nro, TComplemento.getText(), TBairro.getText(), TCEP.getText(),
						TCidade.getText());
