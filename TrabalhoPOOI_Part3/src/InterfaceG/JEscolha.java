			...
			public void actionPerformed(ActionEvent e) {
				...
				if (st.equals("Exclusao")) {
					JOptionPane.showMessageDialog(null,
							"Para realizar a exclusao de um Paciente, pesquise-o no sistema e selecione o botao para excluir.");
		...
		btnFuncionario.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (st.equals("Exclusao")) {
					...
					JOptionPane.showMessageDialog(null,
							"Para realizar a exclusao de um Funcionario, pesquise-o no sistema e selecione o botao para excluir.");
					exclusao.setVisible(true);
					exclusao.setLocationRelativeTo(null);
					dispose();
				}
		...
		btnPlanoSaude.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (st.equals("Exclusao")) {
					...
					JOptionPane.showMessageDialog(null,
							"Para realizar a exclusao de um Plano de Saude, pesquise-o no sistema e selecione o botao para excluir.");
					exclusao.setVisible(true);
					exclusao.setLocationRelativeTo(null);
					dispose();
				}
