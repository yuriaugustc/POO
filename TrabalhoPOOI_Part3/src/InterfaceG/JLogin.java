...
public class JLogin extends JFrame {
	...
	public JLogin() {
		...
		JLabel lblEstaUma = new JLabel(
				"Esta \u00E9 uma area apenas para funcion\u00E1rios, se voc\u00EA n\u00E3o \u00E9");
		...
		btnAvancar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (user.length() == 0 || password.length() == 0) {
					JOptionPane.showMessageDialog(null, "Insira um usuario ou Senha valida!",
							"Usuario ou Senha invalida", JOptionPane.ERROR_MESSAGE, null);
				}
			}
