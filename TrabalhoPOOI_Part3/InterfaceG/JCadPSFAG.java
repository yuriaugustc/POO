...
public class JCadPSFAG extends JFrame {
	...
	public JCadPSFAG(String cpf) {
		...
		JLabel lblParaIssoPrecisamos = new JLabel(
				"Para isso, precisamos que preencha as informa\u00E7\u00F5es a seguir:");
		...
		Concluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				pac.setValor_ult_consulta(Double.parseDouble(TValorUltConsulta.getText()));
