			...
			public void actionPerformed(ActionEvent e) {
				if (rdbtnSim.isSelected() || rdbtnNao.isSelected()) {
					if (cpf.equals("cadPlan")) {
						...
						PlanoDeSaude plan = new PlanoDeSaude(TNomePlano.getText(), TCNPJ.getText(), TRua.getText(), vlr,
								TComplemento.getText(), TBairro.getText(), TCEP.getText(), TCidade.getText());
						DadosPlanoSaude.cadastra(plan);
						DadosPlanoSaude.write();
					} else {
						PacienteComPlano pac = new PacienteComPlano();
						pac = DadosPacComPlano.search(cpf);
						int vlr = Integer.parseInt(TNumero.getText());
						pac.setPlanoAtivo(TNomePlano.getText(), TCNPJ.getText(), TRua.getText(), vlr,
								TComplemento.getText(), TBairro.getText(), TCEP.getText(), TCidade.getText());
						DadosPacComPlano.remove(cpf);
						DadosPacComPlano.cadastra(pac);
						DadosPacComPlano.write();
					}
					dispose();
				}
			}
